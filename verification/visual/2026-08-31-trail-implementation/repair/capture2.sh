...
cp "$ROOT/jumper.py" "$OUT/jumper.py"
...
"$CUA" clipboard_write "{\"text\":\"python3 -u jumper.py\"}" >"$OUT/clip.json"
...
sleep 0.9
screencapture -x -o -S -l "$WIN_ID" "$OUT/pre_jump.png"
