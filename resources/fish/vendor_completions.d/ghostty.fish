set -l commands "+version +help +list-fonts +list-keybinds +list-themes +list-colors +list-actions +ssh +ssh-cache +edit-config +show-config +explain-config +validate-config +show-face +crash-report +boo +new-window +new-tab +toggle-quick-terminal"
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l cursor-trail  -f -d "If `true`, enables a built-in cursor glow and motion trail effect."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l cursor-trail-opacity -r -f -d "The opacity (opposite of transparency) of the built-in cursor glow and motion trail (`cursor-trail`)."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l cursor-trail-duration -r -f -d "The duration of the built-in cursor glow and motion trail (`cursor-trail`)."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l text-animation -r -f -a "none streaming typewriter" -d "Controls the built-in text animation applied to newly output glyphs."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l text-animation-duration -r -f -d "The duration of the built-in text animation (`text-animation`)."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l text-animation-intensity -r -f -d "The intensity of the built-in text animation (`text-animation`)."
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l scrollback-limit-bytes -r -f -d "The size of the scrollback buffer in bytes."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l scrollback-limit-lines -r -f -d "The maximum number of lines of scrollback to retain."
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l scrollback-compression  -f -d "Whether to compress scrollback pages while the terminal is idle."
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l link-osc8  -f -d "Enable hyperlinks created with the OSC 8 escape sequence."
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l drag-handle -r -f -a "always auto never" -d "Controls when drag handles are shown over splits, allowing splits to be rearranged with mouse controls."
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l middle-click-action -r -f -a "primary-paste ignore" -d "The action to take when the user middle-clicks on the terminal surface."
...
complete -c ghostty -n "not __fish_seen_subcommand_from $commands" -l gtk-horizontal-tab-scroll  -f -d "If `true` (default), then two-finger horizontal scrolling on a touchpad will switch between tabs."
...
complete -c ghostty -n "string match -q -- '+*' (commandline -pt)" -f -a "+version +help +list-fonts +list-keybinds +list-themes +list-colors +list-actions +ssh +ssh-cache +edit-config +show-config +explain-config +validate-config +show-face +crash-report +boo +new-window +new-tab +toggle-quick-terminal"
...
complete -c ghostty -n "__fish_seen_subcommand_from +ssh" -l forward-env -f
complete -c ghostty -n "__fish_seen_subcommand_from +ssh" -l terminfo -f
complete -c ghostty -n "__fish_seen_subcommand_from +ssh" -l cache -f
complete -c ghostty -n "__fish_seen_subcommand_from +ssh" -l ssh -r -f
complete -c ghostty -n "__fish_seen_subcommand_from +ssh" -l verbose -f
...
complete -c ghostty -n "__fish_seen_subcommand_from +ssh-cache" -l prune -r -f
...
complete -c ghostty -n "__fish_seen_subcommand_from +new-tab" -l class -r -f
complete -c ghostty -n "__fish_seen_subcommand_from +new-tab" -l surface-id -r -f
complete -c ghostty -n "__fish_seen_subcommand_from +toggle-quick-terminal" -l class -r -f
