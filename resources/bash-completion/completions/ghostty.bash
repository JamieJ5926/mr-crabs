_ghostty() {
  ...
  _handle_config() {
    ...
    config+=" '--cursor-trail '"
    config+=" --cursor-trail-opacity="
    config+=" --cursor-trail-duration="
    config+=" --text-animation="
    config+=" --text-animation-duration="
    config+=" --text-animation-intensity="
    config+=" --cursor-style="
    ...
    config+=" --scrollback-limit-bytes="
    config+=" --scrollback-limit-lines="
    config+=" '--scrollback-compression '"
    config+=" --scrollbar="
    config+=" --link="
    config+=" '--link-url '"
    config+=" '--link-osc8 '"
    ...
    config+=" '--gtk-horizontal-tab-scroll '"
    ...
    case "$prev" in
      ...
      --cursor-trail) return ;;
      --cursor-trail-opacity) return ;;
      --cursor-trail-duration) return ;;
      --text-animation) _compreply compgen -W "none streaming typewriter" -- "$cur"; _add_spaces ;;
      --text-animation-duration) return ;;
      --text-animation-intensity) return ;;
      ...
      --scrollback-limit-bytes) return ;;
      --scrollback-limit-lines) return ;;
      --scrollback-compression) return ;;
      ...
      --drag-handle) _compreply compgen -W "always auto never" -- "$cur"; _add_spaces ;;
      ...
      --middle-click-action) _compreply compgen -W "primary-paste ignore" -- "$cur"; _add_spaces ;;
      ...
      --gtk-horizontal-tab-scroll) return ;;
  ...
  _handle_actions() {
    ...
    local ssh="'--forward-env ' '--terminfo ' '--cache ' --ssh= '--verbose ' --help"
    local ssh_cache="'--clear ' --add= --remove= --prune= --help"
    ...
    local new_tab="--class= --surface-id= --help"
    local toggle_quick_terminal="--class= --help"
    ...
    case "${COMP_WORDS[1]}" in
      ...
      +new-tab)
        case $prev in
          --class) return;;
          --surface-id) return;;
          *) _compreply compgen -W "$new_tab" -- "$cur" ;;
        esac
      ;;
      +toggle-quick-terminal)
        case $prev in
          --class) return;;
          *) _compreply compgen -W "$toggle_quick_terminal" -- "$cur" ;;
        esac
      ;;
      *) _compreply compgen -W "--help" -- "$cur" ;;
    esac
  ...
  topLevel+=" +new-window"
  topLevel+=" +new-tab"
  topLevel+=" +toggle-quick-terminal"
