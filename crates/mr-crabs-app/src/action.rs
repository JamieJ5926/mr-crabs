...
pub enum AppAction {
    ...
    Quit,
    /// Set text animation to none (palette-only, process-local).
    SetTextAnimationNone,
    /// Set text animation to streaming (palette-only, process-local).
    SetTextAnimationStreaming,
    /// Set text animation to typewriter (palette-only, process-local).
    SetTextAnimationTypewriter,
    /// Toggle cursor trail (palette-only, process-local).
    ToggleCursorTrail,
}
