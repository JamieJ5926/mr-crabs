...
pub fn gpui_action_name(action: AppAction) -> &'static str {
    match action {
        ...
        AppAction::ToggleExternalChatPresentation => "mr_crabs::ToggleExternalChatPresentation",
    }
}
...
pub fn action_struct(action: AppAction) -> Box<dyn Action> {
    match action {
        ...
        AppAction::ToggleExternalChatPresentation => Box::new(ToggleExternalChatPresentation),
    }
}
...
fn binding_for(keys: &str, action: AppAction) -> KeyBinding {
    match action {
        ...
        AppAction::SetTextAnimationStreaming => {
            KeyBinding::new(keys, SetTextAnimationStreaming, None)
        }
        ...
        AppAction::ToggleExternalChatPresentation => KeyBinding::new(keys, ToggleExternalChatPresentation, None),
    }
}
